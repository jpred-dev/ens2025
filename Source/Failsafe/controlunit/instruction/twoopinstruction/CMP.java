...
public final class CMP extends TwoOpInstruction {

	public CMP(InstructionData inst) {
		super(inst);
	}
	...
	public void run(Architecture arc) {
		...
		//Mismo comportamiento que la instrucción SUB pero sin almacenar resultados en ninguna parte.
		 ...
		 * 		Esto cubre el caso límite 0-MIN_VALUE, que dará como resultado MIN_VALUE.
